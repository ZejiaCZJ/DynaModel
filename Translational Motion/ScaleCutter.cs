...
namespace DynaModel_v2.Translational_Motion
{
    public class ScaleCutter : GH_Component
    {
        ...
        /// <summary>
        /// Initializes a new instance of the ScaleCutter class.
        /// </summary>
        public ScaleCutter()
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (essentials != null && TrueOnlyButtonValueController_Translational.finished == 0)
            {
        ...
        {
            get { return new Guid("69042638-D5F0-49BB-AB93-1E8773FEBC9D"); }
        }
    }
}