...
namespace DynaModel_v2.Translational_Motion
{
    public class CreateCutter : GH_Component
    {
        ...
        /// </summary>
        public CreateCutter()
          : base("CreateCutter", "CreateCutter",
              "This component create a cutter",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            if (isPressed)
            {
                TrueOnlyButtonValueController_Translational.finished = 0;
        ...
        {
            get { return new Guid("7221C276-A0BA-43F0-A13F-EE7FB1F934B7"); }
        }
    }
}